...
export function License() {
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-[#02040a]">
      ...
      <main className="flex-1 w-full max-w-[1000px] mx-auto px-6 pt-32 pb-24 relative z-10 flex flex-col">
        <motion.div
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <div className="px-3 py-1 rounded-full bg-[rgba(163,230,53,0.1)] border border-[rgba(163,230,53,0.2)]">
              <span className="text-accent-lime text-xs font-mono font-bold tracking-widest uppercase">Open Source</span>
            </div>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white tracking-tight mb-4">
            Apache License 2.0
          </h1>
          <p className="text-lg text-[#8fa3c8] leading-relaxed max-w-2xl">
            NEO-Sentinel is open-source software. Here is a summary of what you can and cannot do, followed by the full legal text.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <GlassCard className="p-6">
            <h3 className="text-white font-bold mb-4 flex items-center gap-3">
              <div className="p-1.5 rounded-full bg-[rgba(163,230,53,0.15)] flex items-center justify-center">
                <Check size={14} className="text-accent-lime" />
              </div> 
              Permissions
            </h3>
            <ul className="text-sm text-[#8fa3c8] space-y-2">
          ...
          <GlassCard className="p-6">
            <h3 className="text-white font-bold mb-4 flex items-center gap-3">
              <div className="p-1.5 rounded-full bg-[rgba(90,200,250,0.15)] flex items-center justify-center">
                <Info size={14} className="text-primary-bright" />
              </div>
              Conditions
            </h3>
            <ul className="text-sm text-[#8fa3c8] space-y-2">
          ...
          <GlassCard className="p-6">
            <h3 className="text-white font-bold mb-4 flex items-center gap-3">
              <div className="p-1.5 rounded-full bg-[rgba(248,113,113,0.15)] flex items-center justify-center">
        ...
        <GlassCard className="p-8 md:p-12 prose prose-invert max-w-none text-sm text-[#8fa3c8]">
          <h2 className="text-white text-xl font-bold mb-6">Apache License<br/><span className="text-base font-normal text-[#5c6f94]">Version 2.0, January 2004<br/>http://www.apache.org/licenses/</span></h2>
